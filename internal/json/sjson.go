// Based on https://github.com/tidwall/sjson but modified to use https://github.com/ohler/ojg instead of encoding/json.
// Credit to https://github.com/tidwall as the original author of sjson.
package json
